...
const macbethQuotes = [
  ...
  {
    act: "Act 3, Scene 4",
    text: "\"Thou canst not say I did it: never shake thy {{gap}} locks at me!\"",
    answer: "gory",
    context: "Macbeth confronts Banquo's ghost, denying guilt publicly.",
    inference: "His public breakdown shows guilt cannot be permanently suppressed.",
    translation: "You can't say I killed you — stop shaking your bloody head at me!"
  },
  {
    act: "Act 4, Scene 1",
    text: "\"By the {{gap}} and drum of him that's given, for Macbeth! Macbeth! Macbeth!\"",
    answer: "pricking",
    context: "The first witch senses Macbeth's approach with supernatural instinct.",
    inference: "The witches remain in control, luring Macbeth deeper into fate.",
    translation: "My thumbs are pricking — something wicked is coming. It's Macbeth!"
  },
  {
    act: "Act 4, Scene 1",
  ...
  {
    act: "Act 4, Scene 3",
    text: "\"He has no {{gap}} now, for his children are more sweet.\"",
    answer: "children",
    context: "Malcolm and Macduff discuss the suffering of Scotland under Macbeth.",
    inference: "Innocent life is destroyed by tyranny — private grief reflects public oppression.",
    translation: "He has no children now — his children were taken from him."
  },
  {
    act: "Act 4, Scene 3",
...
const romeoQuotes = [
  ...
  {
    act: "Act 1, Scene 1",
    text: "\"O brawling love! O loving {{gap}}!\"",
    answer: "hate",
    context: "Romeo uses oxymorons to express his confused emotions about Rosaline.",
    inference: "Love is portrayed as painful and self-contradictory.",
    translation: "Love that brings fighting! Hate that is somehow loving!"
  },
  {
    act: "Act 1, Scene 5",
  ...
  },
  {
    ...
    answer: "hate",
    context: "Juliet discovers Romeo is a Montague — her family's enemy.",
    inference: "Love and hate are inextricably entangled — she cannot escape the feud.",
    translation: "The person I love is the enemy I was born to hate."
  },
  {
    act: "Act 2, Scene 2",
  ...
  {
    act: "Act 4, Scene 1",
    text: "\"And if thou dar'st, I'll give thee {{gap}}.\"",
    answer: "remedy",
    context: "Friar Lawrence offers Juliet a desperate plan to avoid the arranged marriage.",
    inference: "The church itself becomes complicit in deception — institutional solutions are flawed.",
    translation: "If you're brave enough, I have a plan for you."
  },
  {
    act: "Act 4, Scene 1",
  ...
  {
    act: "Act 1, Scene 3",
    text: "\"Younger than she are happy mothers made.\"",
    answer: "she",
    context: "Lord Capulet considers Paris's proposal to marry Juliet.",
    inference: "Juliet is viewed as property in a patriarchal world — her desires are irrelevant.",
    translation: "Girls younger than Juliet are already mothers."
  },
  {
    act: "Act 1, Scene 4",
  ...
  {
    act: "Act 2, Scene 5",
    text: "\"O, she doth {{gap}} she had not stooped so low to leave her husband.\"",
    answer: "teach",
    context: "Romeo gazes at Juliet's apparent corpse in the tomb.",
    inference: "Even in death Juliet is elevated above the world — love transcends mortality.",
    translation: "She teaches the torches to burn more brightly."
  },
  {
    act: "Act 1, Scene 5",
